package top.zjw.requestservice.crawler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://tophub.today/n/Jb0vmloB1G";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"page\"]/div[2]/div[2]/div[1]");

                    System.out.println(titleNodes.length);
                    // 6. 输出结果
                    System.out.println("----- 小米手机新发布 -----");
